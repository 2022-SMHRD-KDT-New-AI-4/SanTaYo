			...
			<div class="inner">
				...
				<section id="banner">
					<div class="content">
						<header>
							<h1>등산모임 일정관리</h1>
							<h1>서비스</h1>
							<p>Santa-YO Mountaineering Meeting Schedule Management System</p>
						</header>
						<p>등산일정관리시스템으로 모집기능, 일정중심의 모집, 일/주/월 단위의 다이어리식 일정관리 기능을 가진 산타요
							사이트입니다.</p>

					</div>

					<span class="image object"> <img src="images/mountain.jpg"
						alt="" />
					</span>
				</section>
				...
				<section>
					...
					<div class="moim">
						...
						%>
						<article
							onclick="location.href='MoimSangseSogae.jsp?group_name=<%=list.get(i).getGroup_name()%>';">

							<!-- 											<a href="MoimSangseSogae.jsp" class="image"><img src="images/tayoLogo.jpg" alt="로고" /></a> -->
							<h2>
								<img alt="" src="images/climber.png" width="45">
								<%=list.get(i).getGroup_name()%></h2>
							<p>
								#
								<%=list.get(i).getGroup_age()%>
								<br>#
								<%=list.get(i).getGroup_gender()%><br>#
								<%=list.get(i).getGroup_level()%><br>
							</p>
							<!-- 											<ul class="actions">

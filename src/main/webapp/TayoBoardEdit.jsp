			...
			<div class="inner">
				...
				<section>
					...
					<div class="joinForm">
						...
						%>
						<form action="BoardUpdateService" method="post">
							<div class="row gtr-uniform">
								

								<INPUT TYPE="hidden" NAME="board_seq" SIZE=10 value='<%=board_seq%>'>
								<INPUT TYPE="hidden" NAME="group_name" SIZE=10 value='<%=group_name%>'>
								
								<div class="col-12">
									<input type="text" name="board_title" id="demo-name"
